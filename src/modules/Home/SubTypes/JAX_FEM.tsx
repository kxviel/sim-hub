...
const JAX_FEM = (homeState: HomeState) => {
	...
	const handleRunSimulation = () => {
		if (files.length === 0) {
			toast.error("Upload a JAX-FEM model configuration.");
			return;
		}
	...
	return (
		<div className="w-full space-y-4">
			<p>Upload a JAX-FEM model configuration and its mesh files.</p>
			...
			<div className="w-full space-y-4 rounded border border-gray-200 p-2">
				<p>
					This template sends one model configuration plus optional FEM mesh
				...
				<div className="w-full space-y-4 rounded border border-gray-200 p-2">
					<p className="font-semibold text-lg">Model Configuration</p>
					<p>
						Upload the governing-equation, material, solver, and
				...
				<div className="w-full space-y-4 rounded border border-gray-200 p-2">
					<p className="font-semibold text-lg">Mesh Files</p>
					<p>Optional meshes and field data consumed by the JAX-FEM model.</p>
